        ...
        <div class="max-w-sm mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <form class="max-w-sm mx-auto" action="{{route('notification.send.push')}}" method="post">
                    @csrf
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">@lang('notification.push_text')</label>
